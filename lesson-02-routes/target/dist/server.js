...
Application.route('/res')
    .get(onGetRes)
    .post(onPostRes);
function onGetRes(_Request, _Response) {
    _Response.end('Res Get');
}
function onPostRes(_Request, _Response) {
    _Response.end('Res Post');
}
Application.route('/afo')
    .get(onGetAfo)
    .post(onPostAfo);
function onGetAfo(_Request, _Response) {
    _Response.end('Afo Get');
}
function onPostAfo(_Request, _Response) {
    _Response.end('Afo Post');
}
// Static files
