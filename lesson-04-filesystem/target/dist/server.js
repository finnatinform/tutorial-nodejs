...
module.exports = patch(__webpack_require__(60))
...
const mkdirs = u(__webpack_require__(144))
const mkdirsSync = __webpack_require__(145)
...
const u = __webpack_require__(2).fromCallback
const rimraf = __webpack_require__(148)
...
const u = __webpack_require__(2).fromCallback
const jsonFile = __webpack_require__(150)
...
var forwarded = __webpack_require__(122)
var ipaddr = __webpack_require__(123)
...
const utimes = __webpack_require__(64).utimesMillis
...
module.exports = {
  copySync: __webpack_require__(147)
}
...
var DataController = __webpack_require__(137);
...
var proto = __webpack_require__(113);
var Route = __webpack_require__(49);
...
module.exports = {
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(41).concat(__webpack_require__(99)) },
...
var finalhandler = __webpack_require__(114);
var Router = __webpack_require__(48);
var methods = __webpack_require__(29);
...
var DataControllerClass = /** @class */ (function () {
    function DataControllerClass() {
        this.onPostData = this.onPostData.bind(this);
        this.onGetData = this.onGetData.bind(this);
    }
    DataControllerClass.prototype.onPostData = function (_Request, _Response) {
        _Response.end(JSON.stringify({ 'success': this.saveData(_Request.body) }));
    };
    DataControllerClass.prototype.onGetData = function (_Request, _Response) {
        _Response.end("Hey, " + this.loadData() + " :)");
    };
    DataControllerClass.prototype.saveData = function (_Data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, fs.ensureFile('./data.json')];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, fs.writeJson('./data.json', _Data)];
                    case 2:
                        _a.sent();
    ...
    DataControllerClass.prototype.loadData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var HResult, _Error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, fs.readJson('./data.json')];
                    case 1:
                        HResult = _a.sent();
                        return [2 /*return*/, HResult.name];
                    case 2:
                        _Error_2 = _a.sent();
                        return [2 /*return*/, ''];
    ...
    return DataControllerClass;
}());
var DataController = new DataControllerClass();
...
assign(fs, __webpack_require__(143))
assign(fs, __webpack_require__(65))
assign(fs, __webpack_require__(3))
assign(fs, __webpack_require__(25))
assign(fs, __webpack_require__(149))
assign(fs, __webpack_require__(153))
assign(fs, __webpack_require__(154))
assign(fs, __webpack_require__(155))
assign(fs, __webpack_require__(156))
assign(fs, __webpack_require__(162))
...
const fs = __webpack_require__(1)
const path = __webpack_require__(0)
const invalidWin32Path = __webpack_require__(63).invalidWin32Path
...
const utimesSync = __webpack_require__(64).utimesMillisSync
...
function copyFileFallback (srcStat, src, dest, opts) {
  ...
  const _buff = __webpack_require__(66)(BUF_LENGTH)
...
jsonFile.outputJson = u(__webpack_require__(151))
jsonFile.outputJsonSync = __webpack_require__(152)
// aliases
...
const u = __webpack_require__(2).fromCallback
const fs = __webpack_require__(1)
const copy = __webpack_require__(62)
const path = __webpack_require__(0)
...
const fs = __webpack_require__(1)
const path = __webpack_require__(0)
const copySync = __webpack_require__(65).copySync
const removeSync = __webpack_require__(25).removeSync
const mkdirpSync = __webpack_require__(3).mkdirsSync
const buffer = __webpack_require__(66)
...
const file = __webpack_require__(157)
const link = __webpack_require__(158)
...
const _symlinkPaths = __webpack_require__(160)
const symlinkPaths = _symlinkPaths.symlinkPaths
const symlinkPathsSync = _symlinkPaths.symlinkPathsSync

const _symlinkType = __webpack_require__(161)
